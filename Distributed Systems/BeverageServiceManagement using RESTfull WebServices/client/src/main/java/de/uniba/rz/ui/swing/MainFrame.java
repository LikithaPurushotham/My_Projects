...
public class MainFrame extends JFrame implements Observer {
	...
	private JPanel createSearchPanel() {
		...
		searchPanel.add(pageField);
		searchPanel.add(new JLabel("limit:"));
		JTextField limitField = new JTextField();
		limitField.setColumns(3);
		...
		searchButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(pageField.getText()!=null && limitField.getText()!=null)
					controller.searchTicket(pageField.getText(), limitField.getText(), searchField.getText(), (de.uniba.rz.entities.Type) typeBox.getSelectedItem());
				else
					controller.searchTicket(pageField.getText(), limitField.getText(), searchField.getText(), (de.uniba.rz.entities.Type) typeBox.getSelectedItem());
			}
		});
