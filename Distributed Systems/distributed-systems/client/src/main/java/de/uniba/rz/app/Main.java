...
public class Main {
	 ...
	 * 
	 * @param args
	 * @throws WebServiceNotAvailableException 
	 */
	public static void main(String[] args) throws WebServiceNotAvailableException {
	 ...
	 */
	private static TicketManagementBackend evaluateArgs(String[] args) throws WebServiceNotAvailableException {
		if (args == null || args.length == 0) {
			...
			case "udp":
				return new UDPTicketManagementBackend((String)args[1], Integer.parseInt(args[2]));
				
			case "jms":
				return new JMSTicketManagementBackend(args[1], args[2]);
				
			case "gRPC" :
				return new GRPCTicketManagementBackend((String)args[1], Integer.parseInt(args[2]));
				
			case "jax" :
				return new JaxWSTicketManagementBackend();	
