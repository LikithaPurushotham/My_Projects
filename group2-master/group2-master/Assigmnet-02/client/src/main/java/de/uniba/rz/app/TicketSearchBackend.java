...
public interface TicketSearchBackend {
	 ...
	 */
	default List<Ticket> getTicketsByName(String page, String limit, String name) throws TicketException {
	 ...
	 * @throws TicketException if something failed
	 */
	default List<Ticket> getTicketsByNameAndType(String page, String limit, String name, Type type) throws TicketException {
		throw new UnsupportedOperationException("Not implemented yet");
	}
}